...
The numerical results were carried out with the following setting:
\newline
\newline
...
\textbf{Iteration Count:} Start with backward training. A full cycle of backward then forward training counts as 1 iteration.
...
\textbf{Convergence Criterion:} As we can see from the previous example, filters tend to converge at \textbf{20th iteration}. Thus, we choose 20 iterations for doing this simulation.
